...
class Department
{
    ...
    public void SaveToJson()
    {
        try
        {
            ...
            Console.WriteLine($"{Name} şöbəsi JSON faylına saxlanıldı.");
        }
        catch (Exception ex)
        {
            Console.WriteLine($"Şöbə məlumatlarını JSON faylına yazarkən xəta baş verdi: {ex.Message}");
        }
    }
}
...
class Doctor : Person
{
    ...
    public static void ReserveAppointment(User user, Doctor doctor)
    {
        while (true)
        {
            ...
            {
                Console.WriteLine("Zehmət olmasa düzgün vaxt indeksini daxil edin.");
            }
            catch (Exception ex)
            {
                Console.WriteLine($"Rezervasiya zamanı xeta baş verdi: {ex.Message}");
            }
        }
    }
    ...
    public static Doctor SelectDoctor(Department department)
    {
        ...
        {
            Console.WriteLine("Zəhmət olmasa düzgün həkim indeksini daxil edin.");
            return null;
        }
        catch (Exception ex)
        {
            Console.WriteLine($"Hekim seçimi zamanı xeta baş verdi: {ex.Message}");
            return null;
        }
    }
    ...
    public void SaveToJson()
    {
        try
        {
            ...
            Console.WriteLine($"{FirstName} {LastName} həkimi JSON faylına saxlanıldı.");
        }
        catch (Exception ex)
        {
            Console.WriteLine($"Həkim məlumatlarını JSON faylına yazarkən xəta baş verdi: {ex.Message}");
        }
    }
}
...
class Program
{
    ...
    static void Main(string[] args)
    {
        while (true)
        {
            ...
            {
                Console.WriteLine($"Proqram icrası zamanı xəta baş verdi: {ex.Message}");
            }
        }
    }
    ...
    static User GetUserInformation()
    {
        ...
        {
            Console.WriteLine($"İstifadəçi məlumatlarını daxil edərkən xəta baş verdi: {ex.Message}");
            return null;
        }
    }
    ...
    static Department SelectDepartment()
    {
        ...
        {
            Console.WriteLine("Zehmet olmasa düzgün şöbe indeksini daxil edin.");
            return null;
        }
        catch (Exception ex)
        {
            Console.WriteLine($"Sobe seçimi zamanı xeta baş verdi: {ex.Message}");
            return null;
        }
    }
    ...
    static void SaveUsersToJson()
    {
        try
        {
            ...
            Console.WriteLine("İstifadəçilər JSON faylına saxlanıldı.");
        }
        catch (Exception ex)
        {
...
class User : Person
{
    ...
    public void SaveToJson()
    {
        try
        {
            ...
            Console.WriteLine($"{FirstName} {LastName} istifadəçisi JSON faylına saxlanıldı.");
        }
        catch (Exception ex)
        {
            Console.WriteLine($"İstifadəçi məlumatlarını JSON faylına yazarkən xəta baş verdi: {ex.Message}");
